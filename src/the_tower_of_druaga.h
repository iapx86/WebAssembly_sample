...
#ifndef THE_TOWER_OF_DRUAGA_H
#define THE_TOWER_OF_DRUAGA_H
...
//		sound0->mute(!fSoundEnable);
	...
	void convertOBJ() {
		...
		memset(obj, 0x0f, 0x10000);
		for (int p = 0, q = 0, i = 128; i != 0; q += 64, --i) {
			for (int j = 3; j >= 0; --j) {
				for (int k = 7; k >= 0; --k)
					obj[p++] = OBJ[q + k + 32] >> j & 1 | OBJ[q + k + 32] >> (j + 3) & 2 | OBJ[q + k + 0x2000 + 32] >> j << 2 & 4 | OBJ[q + k + 0x2000 + 32] >> (j + 1) & 8;
				for (int k = 7; k >= 0; --k)
					obj[p++] = OBJ[q + k] >> j & 1 | OBJ[q + k] >> (j + 3) & 2 | OBJ[q + k + 0x2000] >> j << 2 & 4 | OBJ[q + k + 0x2000] >> (j + 1) & 8;
			}
			for (int j = 3; j >= 0; --j) {
				for (int k = 7; k >= 0; --k)
					obj[p++] = OBJ[q + k + 40] >> j & 1 | OBJ[q + k + 40] >> (j + 3) & 2 | OBJ[q + k + 0x2000 + 40] >> j << 2 & 4 | OBJ[q + k + 0x2000 + 40] >> (j + 1) & 8;
				for (int k = 7; k >= 0; --k)
					obj[p++] = OBJ[q + k + 8] >> j & 1 | OBJ[q + k + 8] >> (j + 3) & 2 | OBJ[q + k + 0x2000 + 8] >> j << 2 & 4 | OBJ[q + k + 0x2000 + 8] >> (j + 1) & 8;
			}
			for (int j = 3; j >= 0; --j) {
				for (int k = 7; k >= 0; --k)
					obj[p++] = OBJ[q + k + 48] >> j & 1 | OBJ[q + k + 48] >> (j + 3) & 2 | OBJ[q + k + 0x2000 + 48] >> j << 2 & 4 | OBJ[q + k + 0x2000 + 48] >> (j + 1) & 8;
				for (int k = 7; k >= 0; --k)
					obj[p++] = OBJ[q + k + 16] >> j & 1 | OBJ[q + k + 16] >> (j + 3) & 2 | OBJ[q + k + 0x2000 + 16] >> j << 2 & 4 | OBJ[q + k + 0x2000 + 16] >> (j + 1) & 8;
			}
			for (int j = 3; j >= 0; --j) {
				for (int k = 7; k >= 0; --k)
					obj[p++] = OBJ[q + k + 56] >> j & 1 | OBJ[q + k + 56] >> (j + 3) & 2 | OBJ[q + k + 0x2000 + 56] >> j << 2 & 4 | OBJ[q + k + 0x2000 + 56] >> (j + 1) & 8;
				for (int k = 7; k >= 0; --k)
					obj[p++] = OBJ[q + k + 24] >> j & 1 | OBJ[q + k + 24] >> (j + 3) & 2 | OBJ[q + k + 0x2000 + 24] >> j << 2 & 4 | OBJ[q + k + 0x2000 + 24] >> (j + 1) & 8;
			}
		}
	}
	...
	void xfer8x8(int *data, int p, int k, int pri) {
		...
		if ((ram[k + 0x800] >> 6 & 1) != pri)
			return;
		if ((px = bgcolor[idx | bg[q | 0x00]]) != 0x1f) data[p + 0x000] = px;
		if ((px = bgcolor[idx | bg[q | 0x01]]) != 0x1f) data[p + 0x001] = px;
		if ((px = bgcolor[idx | bg[q | 0x02]]) != 0x1f) data[p + 0x002] = px;
		if ((px = bgcolor[idx | bg[q | 0x03]]) != 0x1f) data[p + 0x003] = px;
		if ((px = bgcolor[idx | bg[q | 0x04]]) != 0x1f) data[p + 0x004] = px;
		if ((px = bgcolor[idx | bg[q | 0x05]]) != 0x1f) data[p + 0x005] = px;
		if ((px = bgcolor[idx | bg[q | 0x06]]) != 0x1f) data[p + 0x006] = px;
		if ((px = bgcolor[idx | bg[q | 0x07]]) != 0x1f) data[p + 0x007] = px;
		if ((px = bgcolor[idx | bg[q | 0x08]]) != 0x1f) data[p + 0x100] = px;
		if ((px = bgcolor[idx | bg[q | 0x09]]) != 0x1f) data[p + 0x101] = px;
		if ((px = bgcolor[idx | bg[q | 0x0a]]) != 0x1f) data[p + 0x102] = px;
		if ((px = bgcolor[idx | bg[q | 0x0b]]) != 0x1f) data[p + 0x103] = px;
		if ((px = bgcolor[idx | bg[q | 0x0c]]) != 0x1f) data[p + 0x104] = px;
		if ((px = bgcolor[idx | bg[q | 0x0d]]) != 0x1f) data[p + 0x105] = px;
		if ((px = bgcolor[idx | bg[q | 0x0e]]) != 0x1f) data[p + 0x106] = px;
		if ((px = bgcolor[idx | bg[q | 0x0f]]) != 0x1f) data[p + 0x107] = px;
		if ((px = bgcolor[idx | bg[q | 0x10]]) != 0x1f) data[p + 0x200] = px;
		if ((px = bgcolor[idx | bg[q | 0x11]]) != 0x1f) data[p + 0x201] = px;
		if ((px = bgcolor[idx | bg[q | 0x12]]) != 0x1f) data[p + 0x202] = px;
		if ((px = bgcolor[idx | bg[q | 0x13]]) != 0x1f) data[p + 0x203] = px;
		if ((px = bgcolor[idx | bg[q | 0x14]]) != 0x1f) data[p + 0x204] = px;
		if ((px = bgcolor[idx | bg[q | 0x15]]) != 0x1f) data[p + 0x205] = px;
		if ((px = bgcolor[idx | bg[q | 0x16]]) != 0x1f) data[p + 0x206] = px;
		if ((px = bgcolor[idx | bg[q | 0x17]]) != 0x1f) data[p + 0x207] = px;
		if ((px = bgcolor[idx | bg[q | 0x18]]) != 0x1f) data[p + 0x300] = px;
		if ((px = bgcolor[idx | bg[q | 0x19]]) != 0x1f) data[p + 0x301] = px;
		if ((px = bgcolor[idx | bg[q | 0x1a]]) != 0x1f) data[p + 0x302] = px;
		if ((px = bgcolor[idx | bg[q | 0x1b]]) != 0x1f) data[p + 0x303] = px;
		if ((px = bgcolor[idx | bg[q | 0x1c]]) != 0x1f) data[p + 0x304] = px;
		if ((px = bgcolor[idx | bg[q | 0x1d]]) != 0x1f) data[p + 0x305] = px;
		if ((px = bgcolor[idx | bg[q | 0x1e]]) != 0x1f) data[p + 0x306] = px;
		if ((px = bgcolor[idx | bg[q | 0x1f]]) != 0x1f) data[p + 0x307] = px;
		if ((px = bgcolor[idx | bg[q | 0x20]]) != 0x1f) data[p + 0x400] = px;
		if ((px = bgcolor[idx | bg[q | 0x21]]) != 0x1f) data[p + 0x401] = px;
		if ((px = bgcolor[idx | bg[q | 0x22]]) != 0x1f) data[p + 0x402] = px;
		if ((px = bgcolor[idx | bg[q | 0x23]]) != 0x1f) data[p + 0x403] = px;
		if ((px = bgcolor[idx | bg[q | 0x24]]) != 0x1f) data[p + 0x404] = px;
		if ((px = bgcolor[idx | bg[q | 0x25]]) != 0x1f) data[p + 0x405] = px;
		if ((px = bgcolor[idx | bg[q | 0x26]]) != 0x1f) data[p + 0x406] = px;
		if ((px = bgcolor[idx | bg[q | 0x27]]) != 0x1f) data[p + 0x407] = px;
		if ((px = bgcolor[idx | bg[q | 0x28]]) != 0x1f) data[p + 0x500] = px;
		if ((px = bgcolor[idx | bg[q | 0x29]]) != 0x1f) data[p + 0x501] = px;
		if ((px = bgcolor[idx | bg[q | 0x2a]]) != 0x1f) data[p + 0x502] = px;
		if ((px = bgcolor[idx | bg[q | 0x2b]]) != 0x1f) data[p + 0x503] = px;
		if ((px = bgcolor[idx | bg[q | 0x2c]]) != 0x1f) data[p + 0x504] = px;
		if ((px = bgcolor[idx | bg[q | 0x2d]]) != 0x1f) data[p + 0x505] = px;
		if ((px = bgcolor[idx | bg[q | 0x2e]]) != 0x1f) data[p + 0x506] = px;
		if ((px = bgcolor[idx | bg[q | 0x2f]]) != 0x1f) data[p + 0x507] = px;
		if ((px = bgcolor[idx | bg[q | 0x30]]) != 0x1f) data[p + 0x600] = px;
		if ((px = bgcolor[idx | bg[q | 0x31]]) != 0x1f) data[p + 0x601] = px;
		if ((px = bgcolor[idx | bg[q | 0x32]]) != 0x1f) data[p + 0x602] = px;
		if ((px = bgcolor[idx | bg[q | 0x33]]) != 0x1f) data[p + 0x603] = px;
		if ((px = bgcolor[idx | bg[q | 0x34]]) != 0x1f) data[p + 0x604] = px;
		if ((px = bgcolor[idx | bg[q | 0x35]]) != 0x1f) data[p + 0x605] = px;
		if ((px = bgcolor[idx | bg[q | 0x36]]) != 0x1f) data[p + 0x606] = px;
		if ((px = bgcolor[idx | bg[q | 0x37]]) != 0x1f) data[p + 0x607] = px;
		if ((px = bgcolor[idx | bg[q | 0x38]]) != 0x1f) data[p + 0x700] = px;
		if ((px = bgcolor[idx | bg[q | 0x39]]) != 0x1f) data[p + 0x701] = px;
		if ((px = bgcolor[idx | bg[q | 0x3a]]) != 0x1f) data[p + 0x702] = px;
		if ((px = bgcolor[idx | bg[q | 0x3b]]) != 0x1f) data[p + 0x703] = px;
		if ((px = bgcolor[idx | bg[q | 0x3c]]) != 0x1f) data[p + 0x704] = px;
		if ((px = bgcolor[idx | bg[q | 0x3d]]) != 0x1f) data[p + 0x705] = px;
		if ((px = bgcolor[idx | bg[q | 0x3e]]) != 0x1f) data[p + 0x706] = px;
		if ((px = bgcolor[idx | bg[q | 0x3f]]) != 0x1f) data[p + 0x707] = px;
	}

	void xfer16x16(int *data, int dst, int src) {
		const int idx = src >> 4 & 0x3f0;
		int px;
