...
struct DigDugII {
	...
	DigDugII() : cpu(18432000 / 12), cpu2(18432000 / 12), timer(60) {
		// CPU周りの初期化
		...
		convertGFX(&obj[0], &OBJ[0], 256, {rseq8(256, 8), rseq8(0, 8)}, {seq4(0, 1), seq4(64, 1), seq4(128, 1), seq4(192, 1)},	{0x20000, 0x20004, 0, 4}, 64);
