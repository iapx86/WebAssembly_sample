...
unsigned char Grobda::SND[0x100], Grobda::BG[0x1000], Grobda::OBJ[0x4000], Grobda::BGCOLOR[0x100];
unsigned char Grobda::OBJCOLOR[0x100], Grobda::RGB[0x20], Grobda::PRG1[0x6000], Grobda::PRG2[0x2000];
short Grobda::GETREADY[8837];
MappySound *Grobda::sound0;
SoundEffect *Grobda::sound1;
...
array<int, Grobda::width * Grobda::height> data = {};
