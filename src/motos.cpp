...
unsigned char Motos::SND[0x100], Motos::BG[0x1000], Motos::OBJ[0x8000], Motos::BGCOLOR[0x100];
unsigned char Motos::OBJCOLOR[0x100], Motos::RGB[0x20], Motos::PRG1[0x8000], Motos::PRG2[0x2000];
...
array<int, Motos::width * Motos::height> data = {};
