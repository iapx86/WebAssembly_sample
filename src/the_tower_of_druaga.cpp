...
unsigned char TheTowerOfDruaga::SND[0x100], TheTowerOfDruaga::BG[0x1000], TheTowerOfDruaga::OBJ[0x4000], TheTowerOfDruaga::BGCOLOR[0x100];
unsigned char TheTowerOfDruaga::OBJCOLOR[0x400], TheTowerOfDruaga::RGB[0x20], TheTowerOfDruaga::PRG1[0x8000], TheTowerOfDruaga::PRG2[0x2000];
